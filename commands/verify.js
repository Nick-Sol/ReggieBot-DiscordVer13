	...
	async execute(interaction, clientm) {
        ...
        try{
            ...
            if(veriCode === String(userinfo.verify)){
                console.log('nice')
                await interaction.reply('Welcome to RedbirdEsports');
            ...
            //verification reply if wrong.
                ...
                interaction.reply('This is an inncorrect verification code. Please enter the correct code sent to you\'re ilstu email.')
